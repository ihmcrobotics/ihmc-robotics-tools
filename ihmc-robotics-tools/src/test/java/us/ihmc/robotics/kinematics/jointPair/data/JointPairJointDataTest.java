...
public class JointPairJointDataTest
{
   ...
   {
      JointPairJointData jointData = new JointPairJointData();
   ...
   public void testSetters()
   {
      ...
      for (int i = 0; i < iters; i++)
      {
         JointPairJointData randomJointData = getRandomJointPairJointData(random);
   ...
   static JointPairJointData getRandomJointPairJointData(Random random)
   {
      JointData rollData = JointDataTest.getRandomJointData(random);
      JointData pitchData = JointDataTest.getRandomJointData(random);

      JointPairJointData jointPairJointData = new JointPairJointData();
      jointPairJointData.getRollJointData().set(rollData);
      jointPairJointData.getPitchJointData().set(pitchData);
