...
public class QuadrantDependentListTest
{
   ...
   public void testIteratorOrdering()
   {
      ...
      for (RobotQuadrant robotQuadrant : quadrantDependentList.keySet())
      {
         ...
         {
         case 0:
            Assertions.assertEquals(RobotQuadrant.FRONT_LEFT, robotQuadrant, "not FRONT_LEFT");
            break;
         case 1:
            Assertions.assertEquals(RobotQuadrant.FRONT_RIGHT, robotQuadrant, "not FRONT_RIGHT");
            break;
         case 2:
            Assertions.assertEquals(RobotQuadrant.HIND_RIGHT, robotQuadrant, "not HIND_RIGHT");
            break;
         case 3:
            Assertions.assertEquals(RobotQuadrant.HIND_LEFT, robotQuadrant, "not HIND_LEFT");
            break;
         }
      }
