...
public class FFmpegTools
{
   ...
   public static boolean checkPointer(Pointer pointerToCheck, String message, boolean throwException)
   {
      ...
      {
         handleError(String.format("pointer == null: {%s}", message), throwException);
         return false;
      }
      else if (pointerToCheck.isNull())
      {
         handleError(String.format("Pointer isNull() returned true: {%s}: {%s}", pointerToCheck.getClass().getSimpleName(), message), throwException);
         return false;
      }
   ...
   public static boolean checkNegativeError(int returnCode, String message, boolean throwException)
   {
      ...
      handleError(String.format("Code {%d} {%s}: {%s}", returnCode, getErrorCodeString(returnCode), message), throwException);
      return false;
   }
   ...
   private static void handleError(String message, boolean throwException)
   {
      if (throwException)
      {
